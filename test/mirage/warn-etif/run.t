Configure the project for Unix:
  ...
  File "config.ml", line 13, characters 52-54:
  13 |     match conf with { hostname } -> ramdisk "secrets\f42"
                                                           ^^
  Warning 14 [illegal-backslash]: illegal backslash escape in string.
  File "config.ml", line 4, characters 2-13:
  4 |   type t = ()
        ^^^^^^^^^^^
  Warning 65 [redefining-unit]: This type declaration is defining a new '()' constructor
  which shadows the existing one.
  Hint: Did you mean 'type t = unit'?
  File "config.ml", line 5, characters 2-14:
  5 |   type t' = ()
        ^^^^^^^^^^^^
  Warning 65 [redefining-unit]: This type declaration is defining a new '()' constructor
  which shadows the existing one.
  Hint: Did you mean 'type t' = unit'?
  File "config.ml", line 8, characters 14-18:
  8 | let rec eth = etif default_network
                    ^^^^
  Alert deprecated: Mirage.etif
  Deprecated. Use [ethif] instead.
  File "config.ml", line 8, characters 8-11:
  8 | let rec eth = etif default_network
              ^^^
  Warning 39 [unused-rec-flag]: unused rec flag.
  File "config.ml", line 13, characters 20-32:
  13 |     match conf with { hostname } -> ramdisk "secrets\f42"
                           ^^^^^^^^^^^^
  ...
  File "config.ml", line 4, characters 11-13:
  4 |   type t = ()
                 ^^
  ...
  5 |   type t' = ()
        ^^^^^^^^^^^^
  Warning 34 [unused-type-declaration]: unused type t'.
  File "config.ml", line 5, characters 12-14:
  5 |   type t' = ()
                  ^^
  Warning 37 [unused-constructor]: unused constructor ().
  File "config.ml", line 12, characters 6-13:
  12 |   let ramdisk (conf : syslog_config) =
             ^^^^^^^
  Warning 26 [unused-var]: unused variable ramdisk.
  File "config.ml", line 13, characters 22-30:
  13 |     match conf with { hostname } -> ramdisk "secrets\f42"
                             ^^^^^^^^

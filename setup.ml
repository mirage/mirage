...
(* OASIS_START *)
(* DO NOT EDIT (digest: feaf4a203fa3f8d1960bf80aa722abda) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("functhulhu", None);
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [FindlibPackage ("functhulhu.runtime", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "E\006\189\172\194\017c(4p\160\232\238\002Yo";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

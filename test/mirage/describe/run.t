...
Describe before configure (no eval)
  ...
  Output     -digraph G {
                ...
                45 [label="mirage_time__45\nMirage_time\n", shape="box"];
                46 [label="mirage_time__46\nMirage_time\n", shape="box"];
                47 [label="If\ntarget"];
                48 [label="mirage_clock__48\nMirage_clock\n", shape="box"];
                49 [label="mirage_clock__49\nMirage_clock\n", shape="box"];
                50 [label="If\ntarget"];
                51 [label="mirage_timer__51\nMirage_timer\n", shape="box"];
                52 [label="mirage_timer__52\nMirage_timer\n", shape="box"];
                53 [label="mirage_timer__53\nMirage_timer\n", shape="box"];
                54 [label="If\ntarget"];
                55 [label="mirage_logs__55\nMirage_logs\n", shape="box"];
                56 [label="mirage_runtime__56\nMirage_runtime\n", shape="box"];
                57 [label="gc__57\nGc\n", shape="box"];
                58 [label="hashtbl__58\nHashtbl\n", shape="box"];
                59 [label="printexc__59\nPrintexc\n", shape="box"];
                60 [label="mirage_bootvar__60\nMirage_bootvar\n", shape="box"];
                61 [label="mirage_bootvar__61\nMirage_bootvar\n", shape="box"];
                62 [label="mirage_bootvar__62\nMirage_bootvar\n", shape="box"];
                63 [label="If\ntarget"];
                64 [label="struct_end__64\nstruct end\n", shape="box"];
                ...
                43 -> 42 [];
                47 -> 45 [style="dotted", headport="n"];
                47 -> 46 [style="dotted", headport="n"];
                47 -> 45 [style="bold", style="dotted", headport="n"];
                50 -> 48 [style="dotted", headport="n"];
                50 -> 49 [style="dotted", headport="n"];
                50 -> 48 [style="bold", style="dotted", headport="n"];
                54 -> 51 [style="dotted", headport="n"];
                54 -> 51 [style="dotted", headport="n"];
                ...
                54 -> 53 [style="dotted", headport="n"];
                54 -> 53 [style="dotted", headport="n"];
                54 -> 51 [style="bold", style="dotted", headport="n"];
                63 -> 60 [style="dotted", headport="n"];
                63 -> 60 [style="dotted", headport="n"];
                63 -> 61 [style="dotted", headport="n"];
                63 -> 61 [style="dotted", headport="n"];
                63 -> 61 [style="dotted", headport="n"];
                63 -> 61 [style="dotted", headport="n"];
                63 -> 61 [style="dotted", headport="n"];
                63 -> 62 [style="bold", style="dotted", headport="n"];
                64 -> 63 [style="dashed"];
                65 -> 64 [style="dashed"];
                65 -> 59 [style="dashed"];
                65 -> 58 [style="dashed"];

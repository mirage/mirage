...
Describe before configure (no eval)
  ...
  Output     -digraph G {
                ...
                47 [label="If\ntarget"];
                48 [label="mirage_ptime__48\nMirage_ptime\n", shape="box"];
                49 [label="mirage_ptime__49\nMirage_ptime\n", shape="box"];
                50 [label="If\ntarget"];
                51 [label="mirage_sleep__51\nMirage_sleep\n", shape="box"];
                52 [label="mirage_sleep__52\nMirage_sleep\n", shape="box"];
                53 [label="If\ntarget"];
                54 [label="mirage_logs__54\nMirage_logs\n", shape="box"];
                55 [label="mirage_runtime__55\nMirage_runtime\n", shape="box"];
                56 [label="cmdliner_stdlib__56\nCmdliner_stdlib\n", shape="box"];
                57 [label="mirage_bootvar__57\nMirage_bootvar\n", shape="box"];
                58 [label="mirage_bootvar__58\nMirage_bootvar\n", shape="box"];
                59 [label="mirage_bootvar__59\nMirage_bootvar\n", shape="box"];
                60 [label="If\ntarget"];
                61 [label="struct_end__61\nstruct end\n", shape="box"];
                ...
                60 -> 57 [style="dotted", headport="n"];
                60 -> 57 [style="dotted", headport="n"];
                60 -> 58 [style="dotted", headport="n"];
                60 -> 58 [style="dotted", headport="n"];
                60 -> 58 [style="dotted", headport="n"];
                60 -> 58 [style="dotted", headport="n"];
                60 -> 58 [style="dotted", headport="n"];
                60 -> 59 [style="bold", style="dotted", headport="n"];
                61 -> 60 [style="dashed"];
                62 -> 61 [style="dashed"];
                62 -> 56 [style="dashed"];
                62 -> 55 [style="dashed"];

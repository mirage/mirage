...
(* OASIS_START *)
(* DO NOT EDIT (digest: 576b34acd30f13d1c92f1cfcd7d24351) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Functoria_runtime"; "Functoria_info"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "functoria";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "functoria-runtime";
                   ...
                   {
                      lib_modules = ["Functoria"; "Functoria_key"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Functoria_misc"; "Functoria_sigs"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "functoria";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "functoria-app";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "app";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "functoria"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Functoria_app"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Functoria_command_line"; "Functoria_graph"];
                      lib_findlib_parent = Some "functoria";
               ...
               Executable
                 ({
                     cs_name = "test_functoria_command_line";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_functoria_command_line.ml"
                   });
               Test
                 ({
                     cs_name = "test_functoria_command_line";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Functoria";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "93G\223\255\016\233\2337\209!\020\237K\027\218";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

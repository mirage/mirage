...
Describe before configure (no eval)
  ...
  Output     -digraph G {
                ...
                43 -> 42 [];
                48 -> 46 [style="dotted", headport="n"];
                48 -> 47 [style="dotted", headport="n"];
                48 -> 46 [style="bold", style="dotted", headport="n"];
                49 -> 45 [style="dotted", headport="n"];
                49 -> 48 [style="dotted", headport="n"];
                49 -> 45 [style="bold", style="dotted", headport="n"];
                53 -> 51 [style="dotted", headport="n"];
                53 -> 52 [style="dotted", headport="n"];
                53 -> 51 [style="bold", style="dotted", headport="n"];
                54 -> 50 [style="dotted", headport="n"];
                54 -> 53 [style="dotted", headport="n"];
                54 -> 50 [style="bold", style="dotted", headport="n"];
                58 -> 56 [style="dotted", headport="n"];
                58 -> 57 [style="dotted", headport="n"];
                58 -> 56 [style="bold", style="dotted", headport="n"];
                59 -> 55 [style="dotted", headport="n"];
                59 -> 58 [style="dotted", headport="n"];
                59 -> 55 [style="bold", style="dotted", headport="n"];
                66 -> 63 [style="dotted", headport="n"];
                66 -> 63 [style="dotted", headport="n"];
                66 -> 64 [style="dotted", headport="n"];
                66 -> 64 [style="dotted", headport="n"];
                66 -> 64 [style="dotted", headport="n"];
                66 -> 64 [style="dotted", headport="n"];
                66 -> 64 [style="dotted", headport="n"];
                66 -> 65 [style="bold", style="dotted", headport="n"];
                67 -> 66 [style="dashed"];
                68 -> 67 [style="dashed"];
                68 -> 62 [style="dashed"];
                68 -> 61 [style="dashed"];

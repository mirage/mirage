...
(* OASIS_START *)
(* DO NOT EDIT (digest: 03560aa9ae96b319062299ae6c6ff9a6) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "mirari";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "mirari-types";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Mirari_types"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mirari";
                      lib_findlib_name = Some "types";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Wc\127V]\193H \173!\149\218/\156\230\253";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;

...
# 28 "cohttp/http_parser_sanity.mli"
  (** @param value an HTTP header value
# 29 "cohttp/http_parser_sanity.mli"
  @raise Invalid_header_value if value isn't a valid HTTP header value *)
# 30 "cohttp/http_parser_sanity.mli"
val heal_header_value: string -> unit
# 31 "cohttp/http_parser_sanity.mli"

# 32 "cohttp/http_parser_sanity.mli"
  (** @param header a pair header_name * header_value
# 33 "cohttp/http_parser_sanity.mli"
  @raise Invalid_header_name if name isn't a valid HTTP header name
# 34 "cohttp/http_parser_sanity.mli"
  @raise Invalid_header_value if value isn't a valid HTTP header value *)
# 35 "cohttp/http_parser_sanity.mli"
val heal_header: string * string -> unit
# 36 "cohttp/http_parser_sanity.mli"

# 37 "cohttp/http_parser_sanity.mli"
  (** remove heading and/or trailing LWS sequences as per RFC2616 *)
# 38 "cohttp/http_parser_sanity.mli"
val normalize_header_value: string -> string
# 39 "cohttp/http_parser_sanity.mli"

# 40 "cohttp/http_parser_sanity.mli"
end = struct
...
# 34 "cohttp/http_parser_sanity.ml"
let ctls_RE_raw = "\\x00-\\x1F\\x7F"
# 35 "cohttp/http_parser_sanity.ml"
let token_RE_raw = "[^" ^ separators_RE_raw ^ ctls_RE_raw ^ "]+"
# 36 "cohttp/http_parser_sanity.ml"
let lws_RE_raw = "(\r\n)?[ \t]"
# 37 "cohttp/http_parser_sanity.ml"
let quoted_string_RE_raw = "\"(([^\"])|(\\\\\"))*\""
# 38 "cohttp/http_parser_sanity.ml"
let text_RE_raw = "(([^" ^ ctls_RE_raw ^ "])|(" ^ lws_RE_raw ^ "))+"
# 39 "cohttp/http_parser_sanity.ml"
let field_content_RE_raw =
# 40 "cohttp/http_parser_sanity.ml"
  sprintf
# 41 "cohttp/http_parser_sanity.ml"
    "^(((%s)|(%s)|(%s))|(%s))*$"
# 42 "cohttp/http_parser_sanity.ml"
    token_RE_raw
# 43 "cohttp/http_parser_sanity.ml"
    separators_RE_raw
# 44 "cohttp/http_parser_sanity.ml"
    quoted_string_RE_raw
# 45 "cohttp/http_parser_sanity.ml"
    text_RE_raw
# 46 "cohttp/http_parser_sanity.ml"
(*
# 47 "cohttp/http_parser_sanity.ml"
  (* following RFC 2616 specifications *)
# 48 "cohttp/http_parser_sanity.ml"
let field_value_RE_raw = "((" ^ field_content_RE_raw ^ ")|(" ^ lws_RE_raw^ "))*"
# 49 "cohttp/http_parser_sanity.ml"
*)
# 50 "cohttp/http_parser_sanity.ml"
  (* smarter implementation: TEXT production is included in the regexp below *)
# 51 "cohttp/http_parser_sanity.ml"
let field_value_RE_raw =
# 52 "cohttp/http_parser_sanity.ml"
  sprintf
# 53 "cohttp/http_parser_sanity.ml"
    "^((%s)|(%s)|(%s)|(%s))*$"
# 54 "cohttp/http_parser_sanity.ml"
    token_RE_raw
# 55 "cohttp/http_parser_sanity.ml"
    separators_RE_raw
# 56 "cohttp/http_parser_sanity.ml"
    quoted_string_RE_raw
# 57 "cohttp/http_parser_sanity.ml"
    lws_RE_raw
# 58 "cohttp/http_parser_sanity.ml"

# 59 "cohttp/http_parser_sanity.ml"
let token_RE = Pcre.regexp ("^" ^ token_RE_raw ^ "$")
# 60 "cohttp/http_parser_sanity.ml"
let field_value_RE = Pcre.regexp ("^" ^ field_value_RE_raw ^ "$")
# 61 "cohttp/http_parser_sanity.ml"
let heading_lws_RE = Pcre.regexp (sprintf "^%s*" lws_RE_raw)
# 62 "cohttp/http_parser_sanity.ml"
let trailing_lws_RE = Pcre.regexp (sprintf "%s*$" lws_RE_raw)
# 63 "cohttp/http_parser_sanity.ml"

# 64 "cohttp/http_parser_sanity.ml"
let is_token s = Pcre.pmatch ~rex:token_RE s
# 65 "cohttp/http_parser_sanity.ml"
let is_field_name = is_token
# 66 "cohttp/http_parser_sanity.ml"
let is_field_value s = Pcre.pmatch ~rex:field_value_RE s
# 67 "cohttp/http_parser_sanity.ml"

# 68 "cohttp/http_parser_sanity.ml"
let heal_header_name s =
# 69 "cohttp/http_parser_sanity.ml"
  if not (is_field_name s) then raise (Invalid_header_name s) else ()
# 70 "cohttp/http_parser_sanity.ml"

# 71 "cohttp/http_parser_sanity.ml"
let heal_header_value s =
# 72 "cohttp/http_parser_sanity.ml"
  if not (is_field_value s) then raise (Invalid_header_value s) else ()
# 73 "cohttp/http_parser_sanity.ml"

# 74 "cohttp/http_parser_sanity.ml"
let normalize_header_value s =
# 75 "cohttp/http_parser_sanity.ml"
  Pcre.replace ~rex:trailing_lws_RE
# 76 "cohttp/http_parser_sanity.ml"
    (Pcre.replace ~rex:heading_lws_RE s)
# 77 "cohttp/http_parser_sanity.ml"

# 78 "cohttp/http_parser_sanity.ml"
let heal_header (name, value) =
# 79 "cohttp/http_parser_sanity.ml"
  heal_header_name name;
# 80 "cohttp/http_parser_sanity.ml"
  heal_header_value name
# 81 "cohttp/http_parser_sanity.ml"
end
...
# 123 "cohttp/http_parser.ml"

# 124 "cohttp/http_parser.ml"
end
...
# 179 "cohttp/http_message.ml"
    (serialize
# 180 "cohttp/http_message.ml"
       msg
# 181 "cohttp/http_message.ml"
       ()
# 182 "cohttp/http_message.ml"
       (fun () s -> push (Some s); Lwt.return ())
# 183 "cohttp/http_message.ml"
       (fun () buf off len -> push (Some (String.sub buf off len)); Lwt.return ())
# 184 "cohttp/http_message.ml"
       ~fstLineToString >> (push None; Lwt.return ()));
# 185 "cohttp/http_message.ml"
  stream
# 186 "cohttp/http_message.ml"
end
...
# 132 "cohttp/http_request.ml"
	     | l -> None)
# 133 "cohttp/http_request.ml"

# 134 "cohttp/http_request.ml"
end

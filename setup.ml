...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7a455a62291a047e79a6dbe3b6640d5f) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Mirage_types"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mirage";
                      lib_findlib_name = Some "types-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mirage-types-xen";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mirage";
                      lib_findlib_name = Some "types-xen";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
     ...
     oasis_version = "0.4.0";
     oasis_digest = Some "Üuç\007Tß=ã\016îjQ¼\028zÙ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
